    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div>
        ...
        <select
          ...
          onChange={e => update('isFirstBaby', e.target.value === '' ? undefined : e.target.value === 'yes')}
      ...
      <div>
        ...
        <input
          ...
          onChange={e => update('currentPregnancyComplications', splitCsv(e.target.value))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div>
          ...
          <select
            ...
            onChange={e => update('birthExperience.birthType', e.target.value === '' ? undefined : e.target.value)}
        ...
        <div>
          ...
          <select
            ...
            onChange={e => update('birthExperience.birthLocation', e.target.value === '' ? undefined : e.target.value)}
            className="w-full px-3 py-2 border border-[#CAC3BC] rounded-md text-sm"
          >
            <option value="">—</option>
        ...
        <div>
          ...
          <input
            ...
            onChange={e =>
              update('birthExperience.laborDuration', e.target.value === '' ? undefined : Number(e.target.value))
            }
            className="w-full px-3 py-2 border border-[#CAC3BC] rounded-md text-sm"
          />
        </div>
